...
class Adventurer extends Character {
    ...
    rest() {
      ...
      this.health += 20;
      console.log(`${this.name} has recovered 20 health points and now has ${this.health} health.`);
    }
  }
...
class Companion extends Character {
    ...
    follow() {
      console.log(`${this.name} the ${this.species} is following their owner.`);
    }
  
    assist() {
      console.log(`${this.name} the ${this.species} is assisting in the task.`);
      this.roll();
    }
    ...
    increaseLoyalty() {
      this.loyaltyLevel += 1;
      console.log(`${this.name}'s loyalty level has increased to ${this.loyaltyLevel}.`);
    }
  }
// Finally, change the declaration of Robin and the companions to use the new Adventurer and Companion classes.
// Declare Robin as an Adventurer with a specific role
